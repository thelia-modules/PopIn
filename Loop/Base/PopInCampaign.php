...
class PopInCampaign extends BaseLoop implements PropelSearchLoopInterface
{
    ...
    public function parseResults(LoopResult $loopResult)
    {
        ...
        foreach ($loopResult->getResultDataCollection() as $entry) {
            ...
            if ('free-content' == $entry->getContentSourceType()) {
                /** @var PopInFreeContent $popinFreeContent */
                $popinFreeContent = PopInFreeContentQuery::create()
                    ->filterByIdPopInCampaign($entry->getId())
                    ->findOne();

                $row
                    ->set('FREE_TEXT', $popinFreeContent->getTextFree())
                    ->set('LINK', $popinFreeContent->getLink());
            } else {
                $row
                    ->set('FREE_TEXT', "")
                    ->set('LINK', "");
